...
- `f8bd046`: controles de gol, exclusión, tarjeta amarilla y tarjeta roja.
  ...
  - `HEAD`: las vistas abiertas con `Navigator.push` no consultan `GoRouterState` desde el banner; cada pantalla proporciona `selectedIndex`, evitando el error `There is no GoRouterState above the current context`.
