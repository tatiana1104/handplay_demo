...
- [x] El administrador puede crear partidos desde la pantalla de jornadas, asignando equipos, fecha, hora, sede, árbitros y mesa. Las reglas permiten gestionar partidos al administrador del torneo, no solo a usuarios con claim global de administrador.
