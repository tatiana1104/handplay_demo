...
- `f8bd046`: controles de gol, exclusión, tarjeta amarilla y tarjeta roja.
  ...
  - `HEAD`: la sección `Planilla digital` de Partido en vivo solo se muestra a usuarios con rol `arbitro` o `referee`; los demás roles conservan el marcador y la cronología.
