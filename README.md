...
- `f8bd046`: controles de gol, exclusión, tarjeta amarilla y tarjeta roja.
  ...
  - `HEAD`: completar perfil verifica en el servidor que Firestore confirmó `profileCompleted` o `profileCompletedByRole`; normaliza todos los roles y las reglas de Firestore permiten actualizar el perfil propio aunque el documento anterior no tuviera `uid` o `roles` completos.
