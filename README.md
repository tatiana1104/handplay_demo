...
- `f8bd046`: controles de gol, exclusión, tarjeta amarilla y tarjeta roja.
  ...
  - `HEAD`: Completar perfil normaliza los roles `player/jugador`, `coach/entrenador` y `referee/arbitro` antes de guardar, conservando únicamente los roles compatibles con las reglas de Firestore.
