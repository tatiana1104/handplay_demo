...
- `f8bd046`: controles de gol, exclusión, tarjeta amarilla y tarjeta roja.
  ...
  - `HEAD`: completar perfil verifica en el servidor que Firestore confirmó `profileCompleted` antes de cerrar, guarda también `profileCompletedByRole` y vuelve a Perfil mediante GoRouter; la detección funciona para jugador, entrenador, árbitro, público y administradores.
