...
- `f8bd046`: controles de gol, exclusión, tarjeta amarilla y tarjeta roja.
  ...
  - `HEAD`: completar perfil verifica en el servidor que Firestore confirmó `profileCompleted` o `profileCompletedByRole` antes de cerrar; normaliza entrenador/coach, árbitro/referee y admin/admin_liga para que ningún rol vuelva a solicitar el formulario tras guardar.
