...
- [x] Cada árbitro abre un perfil con documento, correo, teléfono y selector para agregar o actualizar su nivel permitido. Si el documento existe carga sus datos y habilita solo los niveles permitidos; si no existe comienza en municipal.
