...
- `f8bd046`: controles de gol, exclusión, tarjeta amarilla y tarjeta roja.
  ...
  - `HEAD`: el banner deriva la opción seleccionada desde la ruta actual; Partido en vivo conserva Calendario como contexto aunque se abra desde una navegación secundaria, evitando marcar Home incorrectamente.
